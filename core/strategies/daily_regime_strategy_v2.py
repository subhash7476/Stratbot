"""Legacy-compatible Daily Regime Strategy V2."""
...
class DailyRegimeStrategyV2(BaseStrategy):
    """Strategy that gates entries based on regime classification."""
    ...
    def process_bar(self, bar: OHLCVBar, context: StrategyContext) -> Optional[SignalEvent]:
        ...
        if regime in ["BULL_TREND", "BEAR_TREND"]:
            if context.analytics_snapshot and getattr(context.analytics_snapshot.signal, "value", "") == "BUY":
                return SignalEvent(
